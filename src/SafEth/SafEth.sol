...
// @audit-issue floating pragma (low)
    ...
    SafEthStorage
{
 ...
 // @audit-info is checks enough?
        ...
        for (uint i = 0; i < derivativeCount; i++) {
            ...
            uint256 ethAmount = (msg.value * weight) / totalWeight; //@audit-info eth anount to deposit
            // for example 1 eth * 20 / 100 = 0.2 eth to deposit
    ...
    */
    function addDerivative(
        ...
        uint256 _weight /* @audit-info _weigth is total % of derivative in common pool */
    ) external onlyOwner {
    ...
    */
    ...
    // @audit-info don't see opposite withdraw function
}
